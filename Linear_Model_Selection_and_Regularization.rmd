...
Finally we can come up with a series of CV errors (MSE in this case since the outsome is continuous)
...
In this example, we notice that MSE is high when lambda is very high, when the model is restricted, and MSE gets lower as  